  ...
  function search(sort) {
      var spots = firebase.database().ref("route5/" + sort);
  ...
  function markers(lat1, long1, word, key, sort) {
      //marker
      storageRef.child('images/route5/' + sort + '/' + key + ".png").getDownloadURL().then(function(url) {
          switch (sort) {
              case "spot":
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
      var waypts = [];
      var checkboxArray = [{ lat:25.0399048, lng: 121.6157193 }, { lat:25.0173067, lng: 121.560432}];
      ...
      directionsService.route({
          origin: { lat: 25.0431023, lng:121.614339},
          destination: { lat:25.0237438, lng: 121.5508153 },
          waypoints: waypts,
