  ...
  function search(sort) {
      var spots = firebase.database().ref("route7/" + sort);
  ...
  function markers(lat1, long1, word, key, sort) {
      //marker
      storageRef.child('images/route7/' + sort + '/' + key + ".png").getDownloadURL().then(function(url) {
          switch (sort) {
              case "spot":
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
      var waypts = [];
      var checkboxArray = [{ lat:23.9522343, lng: 120.6175036}, { lat: 23.9489469, lng: 120.6057823},{ lat:23.952751, lng: 120.6139438}, { lat: 23.9462139, lng: 120.6335473}, { lat: 23.9964414, lng: 120.4659088}, { lat:23.950039, lng: 120.5968022}];
      ...
      directionsService.route({
          origin: { lat:23.9481409, lng:120.6051824},
          destination: { lat:23.9481409, lng:120.6051824},
          waypoints: waypts,
