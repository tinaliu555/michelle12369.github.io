  ...
  function search(sort) {
      var spots = firebase.database().ref("route8/" + sort);
  ...
  function markers(lat1, long1, word, key, sort) {
      //marker
      storageRef.child('images/route8/' + sort + '/' + key + ".png").getDownloadURL().then(function(url) {
          switch (sort) {
              case "spot":
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
      var waypts = [];
      var checkboxArray = [{ lat:25.0585118, lng: 121.5903435}, { lat: 25.0540733, lng: 121.5805305},{ lat:25.056109, lng: 121.5693874}, { lat: 25.0669698, lng: 121.5767373}, { lat: 25.0721688, lng:121.5406953}];
      ...
      directionsService.route({
          origin: { lat:25.0561866, lng:121.6057968},
          destination: { lat:25.0722115, lng: 121.5253743 },
          waypoints: waypts,
