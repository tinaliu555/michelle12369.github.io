  ...
  function search(sort) {
      var spots = firebase.database().ref("route6/" + sort);
  ...
  function markers(lat1, long1, word, key, sort) {
      //marker
      storageRef.child('images/route6/' + sort + '/' + key + ".png").getDownloadURL().then(function(url) {
          switch (sort) {
              case "spot":
  ...
  function calculateAndDisplayRoute(directionsService, directionsDisplay) {
      var waypts = [];
      var checkboxArray = [{ lat:25.2253306, lng: 121.6435516 }, { lat: 25.2218649, lng: 121.6437049},{ lat:25.2218293, lng: 121.6360782}, { lat: 25.2096563, lng: 121.6840113}];
      ...
      directionsService.route({
          origin: { lat:25.2297775, lng:121.6112254},
          destination: { lat:25.1964969, lng: 121.6867545 },
          waypoints: waypts,
